...
import 'package:store/core/ui/widgets/general_error_widget.dart';
import 'package:store/core/ui/widgets/no_data_screen.dart';
...
class PaginationListState<Model> extends State<PaginationList<Model>> {
  ...
  smartRefresher(List<Model> list) {
    ...
    // If shrinkWrap is true, return the child directly without SmartRefresher
    // This prevents viewport height issues when nested in other scrollable widgets
