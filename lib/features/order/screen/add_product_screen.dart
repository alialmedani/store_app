...
/// Allows selecting products through multiple methods:
/// - By Category → Product → Variant
/// - By Product → Variant
/// - All Variants (direct selection)
class AddProductScreen extends fw.StatefulWidget {
  const AddProductScreen({super.key});

  @override
  fw.State<AddProductScreen> createState() => _AddProductScreenState();
}

class _AddProductScreenState extends fw.State<AddProductScreen> {
      ...
      child: SafeArea(
        child: fw.Column(
          children: [
            ...
            // Tab Selection
            fw.Container(
              margin: const fw.EdgeInsets.all(16),
            ...
            fw.Expanded(
              child: fw.Padding(
                padding: const fw.EdgeInsets.symmetric(horizontal: 16),
                      ...
                      fw.Expanded(
                        ...
                        child: PrimaryButton(
                          onPressed: () {
                            ...
                            // Return the selected variant and quantity
  ...
  fw.Widget build(fw.BuildContext context) {
    ...
    return fw.Expanded(
      child: fw.GestureDetector(
        onTap: onTap,
        child: fw.Container(
          padding: const fw.EdgeInsets.symmetric(vertical: 12, horizontal: 12),
          decoration: fw.BoxDecoration(
                  ...
                  return fw.ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return fw.GestureDetector(
                        ...
                        child: fw.Container(
                          width: 160,
                          margin: const fw.EdgeInsets.only(right: 12),
                          padding: const fw.EdgeInsets.all(16),
                          decoration: fw.BoxDecoration(
                            color: isSelected
                  ...
                  return fw.Column(
                    children: List.generate(list.length, (index) {
                      ...
                      return fw.GestureDetector(
                        ...
                        child: fw.Container(
                          margin: const fw.EdgeInsets.only(bottom: 10),
                          padding: const fw.EdgeInsets.all(16),
                          decoration: fw.BoxDecoration(
                            color: isSelected
                                ? theme.colorScheme.primary.withOpacity(0.15)
